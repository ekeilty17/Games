...
class StackedShoe(Shoe):
    ...
    super_split_2_player = ["??", "3?", "A?", "6?", "3?", "A?", "6?", "3?", "8?", "7?", "3?", "3?", "3?", "T?", "K?", "A?", "7?", "A?", "A?", "J?", "A?", "A?", "T?", "A?", "9?"]
    ...
    def shuffle_cards(self):
        ...
        # remember that one card is burned
        # "??" means the code will just find a random card to put there
        stacked_cards = self.super_split_2_player

        # construct the stack by finding these cards in the deck
        beginning_of_the_shoe = []
        end_of_shoe = list(self.cards)
        for s in stacked_cards:
